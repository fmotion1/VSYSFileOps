function Convert-ImageToMetadataExiv2 {
    [CmdletBinding()]
    param (
    ...
    process {
        ...
        $List | ForEach-Object -Parallel {
            ...
            $CurrentFile = $_
            $DestFile = (Get-FilePathComponent -Path $CurrentFile -Component FullPathNoExtension)+" exiv2.txt"
            ...
            [void] (& exiv2 -pa `"$CurrentFile`" 2>&1 | Out-File $DestFile -Encoding utf8)
